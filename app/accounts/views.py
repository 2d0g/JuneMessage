...
import datetime
from flask import render_template, redirect, request, flash, url_for, current_app, session, Blueprint
...
accounts.add_url_rule('/login/', 'login', login, methods=['GET', 'POST'])
accounts.add_url_rule('/logout/', 'logout', logout)
accounts.add_url_rule('/registration/', 'register', register, methods=['GET', 'POST'])
accounts.add_url_rule('/registration/su', 'register_su', register, defaults={'create_su':True}, methods=['GET', 'POST'])
accounts.add_url_rule('/add-user/', 'add_user', add_user, methods=['GET', 'POST'])
accounts.add_url_rule('/users/', view_func=Users.as_view('users'))
accounts.add_url_rule('/users/edit/<username>', view_func=User.as_view('edit_user'))
# accounts.add_url_rule('/su-users/', view_func=SuUsers.as_view('su_users'))
# accounts.add_url_rule('/su-users/edit/<username>', view_func=SuUser.as_view('su_edit_user'))
# accounts.add_url_rule('/user/settings/', view_func=Profile.as_view('settings'))
accounts.add_url_rule('/user/password/', view_func=Password.as_view('password'))